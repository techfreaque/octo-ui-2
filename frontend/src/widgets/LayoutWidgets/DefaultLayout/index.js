...
export default function DefaultLayout(props) {
    ...
    function handleWindowResize() {
        setDimensions({
                ...
                main: window.innerHeight - headerRef.current.clientHeight - footerRef.current.clientHeight
        })
    }
    React.useEffect(() => {
        handleWindowResize()
        ...
        <div style={{flex: 1}} >
            <div style={{
                ...
                <div style={{height: dimensions.main}}>
                    <SplitMainContent {...props} height={dimensions.main} dimensions={dimensions}/>
                </div>
                <div ref={footerRef}>
