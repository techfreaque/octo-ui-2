...
function OptimizerRunFilterValues() {
    return (<>
        <div className="col-4 form-group">
            <select className="w-100 form-control" data-type="user-input" data-role="user_input_left_operand">
                <option value="null"/>
            </select>
        </div>
        <div className="col-1 form-group">
            <select className="w-100 form-control" data-type="operator" data-role="operator">
        ...
        <div className="col-4 form-group">
            <select className="w-100 form-control" data-type="user-input" data-role="user_input_right_operand">
                <option value="null"/>
            </select>
        </div>
        <div className="col-2 form-group">
            <input type="text" className="w-100 form-control" data-type="text" data-role="text_right_operand"/>
        </div>
        <div className="col-1">
            <button type="button" className="btn btn-sm btn-outline-danger waves-effect" data-action="delete">
