  ...
  return (
    <div style={{ display: "flex", justifyContent: "space-between" }}>
      {objectEntries(languages).map(([lng, langData]) => {
        return (
          <Tooltip
            title={t("switch-to-language-name", { lang: langData.nativeName })}
            key={lng}
          >
            <div>
              <LanguageIcons
...
function LanguageIcons({
  ...
  switch (lang) {
    case "de":
      return <GermanyFlag onClick={onClick} />;
    case "en":
      return <USAFlag onClick={onClick} />;
    case "es":
      return <SpainFlag onClick={onClick} />;
    case "zh":
      return <ChinaFlag onClick={onClick} />;
  }
}

function USAFlag({ onClick }: { onClick: () => void }) {
  return (
    <svg
      onClick={onClick}
...
function SpainFlag({ onClick }: { onClick: () => void }) {
  return (
    <svg
      onClick={onClick}
      xmlns="http://www.w3.org/2000/svg"
...
function ChinaFlag({ onClick }: { onClick: () => void }) {
  return (
    <svg
      onClick={onClick}
      xmlns="http://www.w3.org/2000/svg"
...
function GermanyFlag({ onClick }: { onClick: () => void }) {
  return (
    <svg
      onClick={onClick}
      xmlns="http://www.w3.org/2000/svg"
