    ...
    if (app.is_installed) {
        if (app.is_owner) {
            if (app.is_from_store) {
                ...
                return handleUpload && (
                    <UpDownloadloadAppModal onConfirm={()=>handleUpload((isopen)=>handlePopConfirmOpen(setUploadInfo, isopen))}
        ...
        if (app.is_owner) {
            ...
            return handleDownload && (
                <UpDownloadloadAppModal // onConfirm={
                    //     () => addAppStoreCart(app)
                    // }
                ...
                footer={
                    [(
                            <div style={
                                ...
                                {
                                confirmButtonText && (
                                    <AntButton key="confirm"
                                        antIconComponent={confirmButtonIcon}
                                        size="large"
                                        onClick={onConfirm}>
                                        {confirmButtonText} </AntButton>
                                )
                            } </div>
                        ),]
            }>
