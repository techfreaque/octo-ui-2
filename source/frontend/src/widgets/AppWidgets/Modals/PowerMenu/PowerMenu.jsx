    ...
    return (
        <Dropdown onOpenChange={
            ...
            menu={
                {
                    items: open ? [
                        ...
                        },
                        {
                            key: 'restart',
                            label: (
                                <RestartBotButton onClick={handleClose}/>
                            )
                        },
                        {
                            key: 'update',
                            label: (
                                <UpdateBotButton onClick={handleClose}/>
                            )
                        }, {
                            key: 'stop',
                            label: (
                                <StopBotButton onClick={handleClose}/>
                            )
                        }, {
                            key: 'colorMode',
                            label: (
                                <ColorModeSwitch onClick={handleClose}/>
                            )
                        }, {
                            key: 'back',
                            label: (
                                <Button onClick={handleClose}
                                    ...
                                    href={
                                        `${botDomain}/home`
                                }><Trans i18nKey="buttons.backToOctoBot"/></Button>
                            )
                        },
                    ] : []
                }
            ...
            <Tooltip placement="topRight"
                title={
                    (
                        <Trans i18nKey="modal.powerMenuTooltip"/>
                    )
                }
                arrow={false}>
                <div>
