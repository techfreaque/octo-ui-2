...
import {ProfileReferenceMarketSettings, ProfileTradingTypeSettings} from "./ProfileTradingSettings";
    ...
    const tabsData = [
        {
            ...
            content: (<>
                ...
                <ProfileTradingTypeSettings newProfileSettings={newProfileSettings}
                    isCurrentProfile={isCurrentProfile}
                    setNewProfileSettings={setNewProfileSettings}/>
            </>)
        }, {
            title: (<Tab key={1}
                ...
                sx={tabStyle}/>),
            dontScroll: false,
            content: (<ProfileSimulatedSettings newProfileSettings={newProfileSettings}
                isCurrentProfile={isCurrentProfile}
                setNewProfileSettings={setNewProfileSettings}/>)
        },
    ]
    isCurrentProfile && tabsData.push({
        title: (<Tab key={2}
            label={
                (<TabLabel key={2}
    ...
    return (<Modal open={open}
        ...
        footer={
            [(<div key={"profile"} style={
                ...
                <div>
                    <AntButton key="back"
                        antIconComponent={CancelOutlined}
                        size={
                            sizes.large
                        }
                        onClick={handleClose}>
                ...
                <div style={
                    ...
                    (!requiresInstantRestart && isCurrentProfile) && (<AntButton disabled={
                            !hasChanged || loading
                        }
                        key="save2"
                    ...
                    {
                    isCurrentProfile && (<AntButton disabled={
                            !hasChanged || loading
                        }
                        key="saveAndRestart"
                        buttonVariant={
