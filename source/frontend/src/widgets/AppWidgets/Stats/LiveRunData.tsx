...
//       visiblePairs &&
//       visibleTimeframes &&
//       botPlottedElements.live?.[botInfo.live_id]?.[visiblePairs]?.[
//         visibleTimeframes
//       ]?.data?.sub_elements?.forEach((element) => {
//         if (element.type === "dictionary") {
//           const newMetadata = { ...element?.data?.elements[0]?.value };
//           newMetadata["start portfolio"] = JSON.parse(
//             newMetadata["start portfolio"].replace(/'/g, '"')
//           );
//           newMetadata["end portfolio"] = JSON.parse(
//             newMetadata["end portfolio"].replace(/'/g, '"')
//           );
...
//             <div style={{ textAlign: "center" }}>
//               Reference market:
//               <Chip variant="outlined" label={metadata.ref_market} />
//             </div>
//           </Grid>
//           {metadata.future_contracts &&
//             Object.keys(metadata.future_contracts).length && (
...
//                           <>
//                             {Object.keys(
//                               metadata.future_contracts[exchange]
//                             ).map((pair) => (
//                               <div key={pair}>
//                                 {pair}:
//                                 {metadata.future_contracts[exchange][
//                                   pair
//                                 ].contract_type.replace(/_/g, " ") +
//                                   " - " +
//                                   metadata.future_contracts[exchange][
//                                     pair
//                                   ].margin_type.replace(/_/g, " ") +
//                                   " - " +
//                                   metadata.future_contracts[exchange][
//                                     pair
//                                   ].position_mode.replace(/_/g, " ")}
//                               </div>
//                             ))}
//                           </>
//                         }
...
//             <div style={{ textAlign: "center" }}>
//               Symbols:
//               {Object.values(metadata.symbols).map((symbol) => (
...
//             <div style={{ textAlign: "center" }}>
//               Time frames:
//               {Object.values(metadata["time frames"]).map((timeFrame) => (
...
//             <div style={{ textAlign: "center" }}>
//               Trading type:
//               <Chip variant="outlined" label={metadata.trading_type} />
//             </div>
//           </Grid>
//           <Grid item xs={12}>
...
//             <div style={{ textAlign: "center" }}>
//               R² end balance:
//               <Chip variant="outlined" label={metadata["R² end balance"]} />
//             </div>
//           </Grid>
//           <Grid item xs={12} sm={6} md={4} lg={3}>
//             <div style={{ textAlign: "center" }}>
//               R² max balance:
//               <Chip variant="outlined" label={metadata["R² max balance"]} />
//             </div>
//           </Grid>
//           <Grid item xs={12} sm={6} md={4} lg={3}>
//             <div style={{ textAlign: "center" }}>
//               Start portfolio:
//               {Object.keys(metadata["start portfolio"]).map((asset) => (
//                 <Chip
//                   key={asset}
//                   variant="outlined"
//                   label={
//                     asset + ": " + metadata["start portfolio"][asset].total
//                   }
//                 />
//               ))}
//             </div>
...
//             <div style={{ textAlign: "center" }}>
//               End portfolio:
//               {Object.keys(metadata["end portfolio"]).map((asset) => (
//                 <Chip
//                   key={asset}
//                   variant="outlined"
//                   label={asset + ": " + metadata["end portfolio"][asset].total}
//                 />
//               ))}
//             </div>
//           </Grid>
...
//             <div style={{ textAlign: "center" }}>
//               % draw down:
//               <Chip variant="outlined" label={metadata["% draw down"]} />
//             </div>
//           </Grid>
//           <Grid item xs={12} sm={6} md={4} lg={3}>
//             <div style={{ textAlign: "center" }}>
...
//             <div style={{ textAlign: "center" }}>
//               % win rate:
//               <Chip variant="outlined" label={metadata["% win rate"]} />
//             </div>
//           </Grid>
//           <Grid item xs={12} sm={6} md={4} lg={3}>
//             <div style={{ textAlign: "center" }}>
